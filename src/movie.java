...
public class movie extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Varisu", "Thunivu", "Beast" }));

        jComboBox2.setFont(new java.awt.Font("Times New Roman", 1, 24)); 
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Inox", "Galaxy", "Rohini", "PVR" }));
